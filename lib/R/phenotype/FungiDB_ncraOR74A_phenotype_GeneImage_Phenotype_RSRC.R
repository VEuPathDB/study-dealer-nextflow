...
wrangle <- function() {
 ...
 genePhenotype <- genePhenotype %>%
  ...
  genePhenotype <- genePhenotype %>%
    ...
    set_variable_metadata('Sexual_Development', display_order=3, display_name = "Sexual Development", definition = "Sexual Development") %>%
    set_variable_metadata('location', display_order=4, display_name = "location", definition = "location") %>%
    set_variable_metadata('media', display_order=5, display_name = "media", definition = "media") %>%
    set_variable_metadata('morphology', display_order=6, display_name = "morphology", definition = "morphology") %>%
    set_variable_metadata('physiology', display_order=7, display_name = "physiology", definition = "physiology") %>%
